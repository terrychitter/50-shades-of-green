...
5. Once installed, click on the gear icon in the lower-left corner of the Extensions view and select "Color Theme" from the dropdown menu.
6. Select "50 Shades of Green" from the list of available themes.
